...
class SpendReservation(UUIDBase):
    ...
    ad_request_id: Mapped[str | None] = mapped_column(ForeignKey("ad_requests.id"), nullable=True)
...
class PolicyFlag(UUIDBase):
    ...
    live_campaign_id: Mapped[str | None] = mapped_column(ForeignKey("live_campaigns.id"), nullable=True)
