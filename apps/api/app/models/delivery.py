...
class BudgetLedger(UUIDBase): __tablename__="budget_ledgers"; campaign_id: Mapped[str]=mapped_column(ForeignKey("campaigns.id")); amount: Mapped[float]=mapped_column(Numeric(12,4), default=0)
