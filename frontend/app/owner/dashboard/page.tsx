...
export default async function OwnerDashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-black p-6">
      <h1 className="mb-6 text-3xl font-bold text-cyan-200">Owner Command Center // Cyberpunk</h1>
      <CyberpunkDashboard
